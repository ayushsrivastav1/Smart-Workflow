...
const TaskOverview = () => {
  ...
  return (
    <div className='bg-[#2A1E4D] p-5 rounded-lg mt-5 shadow-md'>
        <div className='bg-[#3A1E6E] mb-2 py-2 px-4 flex justify-between rounded'>
        ...
        {userData.map(function(elem,idx){
            return <div key={idx} className='border border-[#6C63FF] mb-2 py-2 px-4 flex justify-between rounded-md text-white bg-[#1E0F3B]'>
